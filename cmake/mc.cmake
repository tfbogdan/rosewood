...
function(assemble_reflection_data target)
	...
	add_custom_command(
                COMMAND mc "$<$<BOOL:${reflectionFiles}>: $<JOIN:${reflectionFiles},; >>" -o ${outputCXXFile} -j ${outputJsonFile} -- "$<$<BOOL:${includeDirs}>:-I$<JOIN:${includeDirs},;-I>>" "$<$<BOOL:${compileDefs}>:-D$<JOIN:${compileDefs},;-D>>" -fsyntax-only -Wno-pragma-once-outside-header
                OUTPUT ${outputCXXFile} ${outputJsonFile}
